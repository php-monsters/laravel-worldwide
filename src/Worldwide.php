...
class Worldwide
{
    ...
    {
        return Config::get('worldwide.insert_activations_only', false);
    }

    public static function isActivateCountries(): bool
    {
        return Config::get('worldwide.countries.activation.default', true);
    }

    public static function isActivateStates(): bool
    {
        return Config::get('worldwide.states.activation.default', true);
    }

    public static function isActivateCities(): bool
    {
        return Config::get('worldwide.cities.activation.default', true);
    }

    public static function getIso2Activate(): array
    {
        return Config::get('worldwide.countries.activation.only.iso2', []);
    }

    public static function getIso3Activate(): array
    {
        return Config::get('worldwide.countries.activation.only.iso3', []);
    }

    public static function getIso2Except(): array
    {
        return Config::get('worldwide.countries.activation.except.iso2', []);
    }

    public static function getIso3Except(): array
    {
        return Config::get('worldwide.countries.activation.except.iso3', []);
    }

    public static function getCountriesChunkLength(): int
    {
        return Config::get('worldwide.countries.chunk_length', 50);
    }

    public static function getStatesChunkLength(): int
    {
        return Config::get('worldwide.states.chunk_length', 200);
    }

    public static function getCitiesChunkLength(): int
    {
        return Config::get('worldwide.cities.chunk_length', 200);
    }
